...
import { useStepper, steps, utils } from './transaction-stepper';
import { Form } from '@/components/ui/form';
import { Button } from '@/components/ui/button';
import CustomerStep from './steps/customer-form';
import ItemStep from './steps/item-form';
import TransactionStep from './steps/transaction-form';
...
const TransactionCreate = () => {
    ...
    const existingItemId = localStorage.getItem('itemId');
    ...
    if (stepper.current.id === 'customer') {
        ...
        isExistingItem = existingItemId !== null;
    ...
    const [formSchema, setFormSchema] = useState(() =>
        isExistingCustomer || isExistingItem
            ? z.object({})
    ...
    }, [isExistingCustomer, isExistingItem, stepper.current.schema]);
